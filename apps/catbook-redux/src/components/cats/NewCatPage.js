// http://www.thegreatcodeadventure.com/react-redux-tutorial-part-vii-the-create-feature/
//=============================================================================
...
function mapStateToProps(state, ownProps) {
  console.log("NewCatPage.mapStateToProps");
  let checkBoxHobbies = [];
...
function mapDispatchToProps(dispatch) {
  console.log("NewCatPage.mapDispatchToProps");
  return {
